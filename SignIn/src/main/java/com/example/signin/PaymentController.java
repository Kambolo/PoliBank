...
public class PaymentController {
    ...
    private BooleanProperty showPaymentComplete = new SimpleBooleanProperty();
    ...
    public void initialize(){
        ...
        paymentResult.visibleProperty().bind(showPaymentComplete);
        showInvalidValue.set(false);
        showPaymentComplete.set(false);
    }
